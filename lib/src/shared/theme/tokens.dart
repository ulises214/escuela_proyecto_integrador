...
const kTokenPrimaryTextColor = kColorXiketic;
const kTokenScaffoldColor = kColorGhostWhite;
const kTokenSecondaryColor = kColorFawn;
const kTokenSecondaryTextColor = kColorWhite;
